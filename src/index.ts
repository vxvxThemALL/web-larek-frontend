...
import { IContacts, IDelivery, IProductItem } from "./types";
...
//Инструментарий оформления заказа
...
//Изменение одного из полей формы
events.on(
	/^order\..*:change/,
